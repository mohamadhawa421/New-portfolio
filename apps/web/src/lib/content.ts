...
export const getContactPage = cache(async (): Promise<ContactPage> => {
  ...
  return {
    ...
    formEmailLabel: text(raw?.formEmailLabel, fb.formEmailLabel),
    formEmailPlaceholder: text(raw?.formEmailPlaceholder, fb.formEmailPlaceholder),
    formErrorEmail: text(raw?.formErrorEmail, fb.formErrorEmail),
    formSendCta: text(raw?.formSendCta, fb.formSendCta),
    formSendingLabel: text(raw?.formSendingLabel, fb.formSendingLabel),
    formSuccess: text(raw?.formSuccess, fb.formSuccess),
    formSendError: text(raw?.formSendError, fb.formSendError),
